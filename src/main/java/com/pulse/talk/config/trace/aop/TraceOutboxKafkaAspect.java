package com.pulse.talk.config.trace.aop;

import com.pulse.talk.config.trace.TraceUtil;
...
public class TraceOutboxKafkaAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around(value = "@annotation(com.pulse.talk.config.trace.annotation.TraceOutboxKafka) && " +
    ...
    public Object traceKafkaListener(
        ...
        Span span = tracer.spanBuilder("Content [kafka-consume] outbox process change [PROCESSED]")
