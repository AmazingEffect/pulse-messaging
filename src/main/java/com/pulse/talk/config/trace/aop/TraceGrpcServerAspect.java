...
import com.pulse.talk.config.grpc.interceptor.GrpcMetadata;
...
public class TraceGrpcServerAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around("@annotation(com.pulse.talk.config.trace.annotation.TraceGrpcServer)")
    public Object traceGrpcServer(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Span span = tracer.spanBuilder("Content [grpc] server response")
